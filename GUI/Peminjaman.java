...
import perpustakaanapp.tubes.Model.LaporanModel;
...
PeminjamanModel pm=new PeminjamanModel();
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if(pesan==JOptionPane.YES_OPTION){
            ...
            dataPinjamDetail.stream().forEach(new ConsumerImpl(bm));
...
private static class ConsumerImpl implements Consumer<PeminjamanDetailModel> {

        private final BukuModel bm;

        public ConsumerImpl(BukuModel bm) {
            this.bm = bm;
        }

        @Override
        public void accept(PeminjamanDetailModel d) {
